...
Каталог попадает на машины релизом сайта. Шаги релиза описаны в
[`.github/workflows/release.yml`](.github/workflows/release.yml).

Изменили плагин — поднимите `version` в его `plugin.json`.
Codex копирует плагин в кеш при установке.
Без новой версии Codex не берёт новые файлы плагина.
